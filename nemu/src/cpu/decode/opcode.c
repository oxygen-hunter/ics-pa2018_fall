...
{__add_i2rm_bv, __or_i2rm_bv, __adc_i2rm_bv, sbb_i2rm_bv, __and_i2rm_bv, sub_i2rm_bv, __xor_i2rm_bv, cmp_i2rm_bv};
...
{inc_rm_v, __ref_dec_rm_v, __ref_call_near_indirect, inv, __ref_jmp_near_indirect, inv, __ref_push_rm_v, inv};
