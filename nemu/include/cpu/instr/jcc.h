...
make_instr_func(jo_near); //0x70
make_instr_func(jno_near); //0x71
make_instr_func(jb_near); //0x72
make_instr_func(jae_near); //0x73
make_instr_func(je_near); //0x74
make_instr_func(jne_near); //0x75
make_instr_func(jna_near); //0x76 jbe
make_instr_func(ja_near); //0x77
make_instr_func(js_near); //0x78
make_instr_func(jns_near); //0x79
make_instr_func(jp_near); //0x7a
make_instr_func(jnp_near); //0x7b
make_instr_func(jl_near); //0x7c
make_instr_func(jge_near); //0x7d
make_instr_func(jle_near); //0x7e
make_instr_func(jg_near); //0x7f
